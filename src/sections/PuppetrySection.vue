...
import LottiePuppetry from '@/assets/LottiePuppetry.jpg'
</script>

<template>
  <section
    class="container relative flex h-screen snap-start snap-always flex-col items-end justify-start space-y-8 overflow-visible px-6 py-8 pb-16 pt-8 text-right">
    ...
    <img
      :src="LottiePuppetry"
      class="absolute -left-[10%] bottom-0 max-h-[40%] w-full max-w-lg -rotate-12" />
  </section>
</template>
